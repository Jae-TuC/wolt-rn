...
function RightAction(prog: SharedValue<number>, drag: SharedValue<number>) {
    const hasReachedThresholdUp = useSharedValue<boolean>(false)
    const hasReachedThresholdDown = useSharedValue<boolean>(false)
            ...
            >
                <View style={styles.orderItem}>
                    ...
                    <View style={styles.itemDetails}>
                        ...
                        <Text style={styles.itemMeta}>{item.quantity} x {(item.dish.price).toFixed(2)}€</Text>
