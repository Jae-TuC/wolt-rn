...
const Page = () => {
    ...
    const dashId = parseFloat(id || "0")
    const cartStore = useCartStore()

    const { data: dish, isLoading } = useDish(dashId)
    ...
    return (
        <>
            <View style={[styles.container]}>
                {/* Close Button */}
                <TouchableOpacity style={[styles.closeButton, { top: inset.top }]} onPress={() => router.back()}>
                ...
                <ScrollView
                    ...
                    contentContainerStyle={{ marginBottom: 100, marginTop: inset.top }}>
                    {/* Dish Image */}
            ...
            <View style={[styles.bottomBar, { marginBottom: inset.bottom }]}>
                {/* Quantity Controls */}
